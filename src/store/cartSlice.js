            ...
            if (isItemInCart) {
                const tempCart = state.carts.map(item => {
                    if (item.id === action.payload.id) {
                        ...
                        let tempTotalPrice = tempQty * item.unitPrice;
                ...
                const unitPrice = action.payload.discountedPrice || action.payload.price;
                const totalPrice = action.payload.quantity * unitPrice;
        
                state.carts.push({ ...action.payload, totalPrice, unitPrice });
                storeInLocalStorage(state.carts);
            }
        },
